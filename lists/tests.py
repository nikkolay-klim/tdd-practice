...
class HomePageTest(TestCase):
    ...
    def test_home_page_return_correct_html(self):
        ...
        expected_html = render_to_string('lists/templates/home.html')
...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        Item.objects.create(text='itemaz 1', list=correct_list)
        Item.objects.create(text='itemaz 2', list=correct_list)
        ...
        self.assertContains(response, 'itemaz 1')
        self.assertContains(response, 'itemaz 2')
    ...
    def test_uses_list_template(self):
        ...
        self.assertTemplateUsed(response, 'lists/templates/list.html')
